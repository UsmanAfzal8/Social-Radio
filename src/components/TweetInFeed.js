...
const TweetInFeed = ({ profile }) => {
  ...
  const like = async (id, count) => {
    ...
    const tweet = await query.first();

    tweet.set("likeCount", count + 1);
            ...
            <div className="feedTweet">
              ...
              <div className="completeTweet">
                ...
                <div className="interactions">
                  ...
                  <div className="interactionNums" onClick={()=>like(e.id, e.attributes.likeCount)}>
                    <Icon fill="#3f3f3f" size={20} svg="star" />
                    {e.attributes.likeCount}
                  </div>
